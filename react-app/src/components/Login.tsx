    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 font-inter text-gray-800 antialiased">
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md animate-scale-in">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="username" className="block text-gray-700 text-lg font-semibold mb-2">Email</label>
            <input
              type="text"
              id="username"
          ...
          <div className="mb-6 relative"> 
            ...
            <button
              ...
              className="absolute right-0 top-2/3 -translate-y-[46%] pr-3 flex items-center text-gray-800 hover:text-gray-950 text-xl focus:outline-none"
